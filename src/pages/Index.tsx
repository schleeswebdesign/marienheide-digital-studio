...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden" <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden" style={{ backgroundImage: 'url(/istockphoto-1933752815-612x612.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>>
        {/* Dark overlay */}
