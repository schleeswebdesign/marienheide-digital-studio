          ...
          <AnimatedSection>
            <div className="max-w-3xl">
              <h1 className="text-4xl leading-tight mb-6 text-left md:text-5xl font-semibold font-serif mx-0 py-[20px] my-0 px-[20px]" style={{ animation: 'hero-fade-in 0.9s ease-out 0.05s both' }}>
                ​Sie sind gut in Ihrem Job. Wir sorgen dafür, dass Ihre <span className="bg-gradient-to-r ​Sie sind gut in Ihrem Job. Wir sorgen dafür, dass Ihre <span className="bg-gradient-to-r from-[#7DD3FC] to-[#7DD3FC] bg-clip-text text-transparent">Kunden</span> das auch wissen. bg-clip-text text-transparent">Kunden</span> das auch wissen.
              </h1>
